...
public sealed partial class JArray
{
    ...
    /// <returns>The number of values removed from the <see cref="JArray"/>.</returns>
    ...
    /// <summary>Removes a range of values from the <see cref="JArray"/>.</summary>
    ...
    /// <exception cref="ArgumentException"><paramref name="index"/> and <paramref name="count"/> do not denote a valid range of values in the <see cref="JArray"/>.</exception>
